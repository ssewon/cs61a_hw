...
class VendingMachine:
    ...
    def vend(self):
        if self.stock == 0:
            ...
            self.balance = 0
            self.stock -= 1
            return 'Here is your ' + self.name + ' and ${0} change.'.format(change)
        else:
            self.balance = 0
            self.stock -= 1
    ...
    def add_funds(self, add_amount):
        if self.stock == 0:
            return 'Machine is out of stock. Here is your ${0}.'.format(add_amount)
        else:
    ...
    def restock(self, add_stock):
        ...
        return 'Current ' + self.name + ' stock: {0}'.format(self.stock)
